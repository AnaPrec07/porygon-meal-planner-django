...
from .views import FoodViewSet, RecipeViewSet, MealPlanViewSet, UserPreferenceViewSet, UserProgressViewSet, UserViewSet, RegisterUserView, ai_chatbot, accept_recipe, user_progress, user_mealplans
